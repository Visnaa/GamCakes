...
public class ModItems
{
    ...
    public static final RegistryObject<BlockItem> DOLOMITE_CAKE = ITEMS.register("dolomite_cake", () -> new BlockItem(ModBlocks.DOLOMITE_CAKE.get(), new Item.Properties().group(Main.ITEM_GROUP)));
    public static final RegistryObject<BlockItem> TANZANITE_CAKE = ITEMS.register("tanzanite_cake", () -> new BlockItem(ModBlocks.TANZANITE_CAKE.get(), new Item.Properties().group(Main.ITEM_GROUP)));
}
